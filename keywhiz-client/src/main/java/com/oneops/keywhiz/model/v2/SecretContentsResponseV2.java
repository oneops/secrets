...
public abstract class SecretContentsResponseV2 {
    ...
    public abstract static class Builder {
        ...
        abstract Builder successSecrets(ImmutableMap<String, String> successSecrets);

        abstract Builder missingSecrets(ImmutableList<String> missingSecrets);


        public Builder successSecrets(Map<String, String> successSecrets) {
